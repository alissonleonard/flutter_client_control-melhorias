...
void main() {
  ...
  testWidgets('Integration Test', (tester) async {
    ...
    await tester.enterText(find.byKey(const Key('NameKey1')), 'Alisson');
    await tester.enterText(
        find.byKey(const Key('EmailKey1')), 'alisson12@gmail.com.br');
    ...
    expect(find.text('Alisson (Ferro)'), findsOneWidget);
    expect(find.byIcon(Icons.card_giftcard), findsOneWidget);
